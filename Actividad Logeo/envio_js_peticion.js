...
btnGet.addEventListener("click", function () {
    ...
    axios.get("http://localhost:5500/Actividad Logeo" + params)
        .then(function (rs) {
            console.log(rs.data);
            alert(rs.data)
        })
...
btnPost.addEventListener("click", function () {
    ...
    params.append("pass", pass);
    console.log(params.get("nombre"))
    axios.post("http://localhost:5500/hola", params)
        .then(function (rs) {
            console.log(rs.data);
            alert(rs.data)
        })
...
btnGetJson.addEventListener("click", function () {
    ...
    axios.get("http://localhost:5500/holaJson?" + params)
        .then(function (rs) {
            console.log(rs.data);
            alert(rs.data.time)
        })
...
btnPostJson.addEventListener("click", function () {
    ...
    axios.post("http://localhost:5500/holaJson", { "nombre": params.get("nombre"), pass: params.get("pass") } )
        .then(function (rs) {
            console.log(rs.data);
            //alert(rs.data)
        })
